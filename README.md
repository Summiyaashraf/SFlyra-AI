...
- Typography: pair an elegant serif display font (like Fraunces) for headlines with a clean modern sans-serif (like Sora) for body text and UI

- Overall vibe: premium, tech-forward AI agency — not generic, not templated. Add subtle twinkling sparkle/particle effects drifting across the background, soft glow effects behind key elements, and a one-time sparkle burst animation around the logo on page load.
...
7. Founders section — two equal cards side by side for the two founders (Fatimah Noman and Sumiya), each with a photo, name, role "Co-Founder, SFlyra Labs", and a short 1-2 line bio.

8. Process section — 4-step numbered grid: Discover, Design, Build, Launch, each with a short description.
...
**Live app**: https://sflyra-labs.lovable.app

## Build with Lovable

Continue developing this project in the [Lovable editor](https://lovable.dev/projects/95c1a94b-90c1-4d05-8eb9-faaa32ae2f51).
